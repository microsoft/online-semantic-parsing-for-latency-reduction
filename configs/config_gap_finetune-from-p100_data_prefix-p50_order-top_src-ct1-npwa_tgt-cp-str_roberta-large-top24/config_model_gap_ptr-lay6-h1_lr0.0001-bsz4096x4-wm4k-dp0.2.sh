...
##### load data config
config_data=configs/config_data_prefix/config_data_prefix-p50_order-top_src-ct1-npwa_tgt-cp-str_roberta-large-top24.sh
...
validset=valid-prefix50p    # validation subset during training time
...
# finetune from previous model: full utterance to full plan, 50 epochs -> issue: dictionary NEEDS to be the same
# starting_model=$SAVEDIR/projects/calflow-gap-initial/amlt-results/7372554431.87946-26b82095-7408-4471-80c6-f666a27ab492/exp_order-top_src-ct1-npwa_tgt-cp-str_roberta-large-top24_gap_vmask1_shiftpos1_ptr-lay6-h1_scp-lay5-h1_dec-emb-sha0/models_ep50_seed42_fp16-lr0.0005-mt4096x4-wm4000-dp0.2/checkpoint50.pt
starting_model=$SAVEDIR/exp_prefix-p100_order-top_src-ct1-npwa_tgt-cp-str_roberta-large-top24_gap_vmask1_shiftpos1_ptr-lay6-h1_scp-lay5-h1_dec-emb-sha0/models_ep50_seed42_fp16-lr0.0005-mt4096x4-wm4000-dp0.2/checkpoint50.pt
TRAIN_ARGS="${TRAIN_ARGS}
    --finetune-from-model $starting_model
    "
finetune_flag=_finetune-from-p100
...
expdir=exp${finetune_flag}_${data_tag}_gap_vmask${tgt_vocab_masks}_shiftpos${shift_pointer_value}
