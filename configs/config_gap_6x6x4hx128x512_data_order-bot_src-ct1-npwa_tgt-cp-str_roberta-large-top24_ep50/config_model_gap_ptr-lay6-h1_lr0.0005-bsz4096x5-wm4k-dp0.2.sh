...
##### load data config
config_data=configs/config_data/config_data_order-bot_src-ct1-npwa_tgt-cp-str_roberta-large-top24.sh
...
arch=transformer_tgt_pointer_scp_6x6x4hx128x512
arch_tag=_6x6x4hx128x512
