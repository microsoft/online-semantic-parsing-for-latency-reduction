...
##### load data config
config_data=configs/config_data_prefix_order-bot/config_data_prefix-p80_order-bot_src-ct1-npwa_tgt-cp-str_roberta-large-top24.sh
...
validset=valid-prefix80p    # validation subset during training time
