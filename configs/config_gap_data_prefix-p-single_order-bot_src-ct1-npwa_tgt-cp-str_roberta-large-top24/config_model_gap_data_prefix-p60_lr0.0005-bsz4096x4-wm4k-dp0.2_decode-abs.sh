...
##### load data config
config_data=configs/config_data_prefix_order-bot/config_data_prefix-p60_order-bot_src-ct1-npwa_tgt-cp-str_roberta-large-top24.sh
...
##### reload data config for abs prefix validation data -> overwrite the validation data folder
config_data=configs/config_data_abs-prefix/config_data_abs-prefix_order-top_src-ct1-npwa_tgt-cp-str_roberta-large-top24.sh
. $config_data
...
validset=valid-prefix60p    # validation subset during training time
