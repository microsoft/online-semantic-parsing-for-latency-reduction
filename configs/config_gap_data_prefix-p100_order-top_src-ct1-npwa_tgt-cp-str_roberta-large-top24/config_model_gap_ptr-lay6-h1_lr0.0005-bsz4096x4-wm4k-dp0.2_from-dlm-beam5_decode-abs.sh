...
##### load data config
config_data=configs/config_data_prefix/config_data_prefix-p100_order-top_src-ct1-npwa_tgt-cp-str_roberta-large-top24.sh
...
config_data=configs/config_data_abs-prefix/config_data_abs-prefix_from-dlm-beam5_order-top_src-ct1-npwa_tgt-cp-str_roberta-large-top24.sh
. $config_data
