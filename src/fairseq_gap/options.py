...
def add_preprocess_args(parser):
    ...
    group.add_argument('--remove-be', default=1, type=int,
                       help='whether to remove bos and eos token encodings/embeddings '
                            'from the pretrained features')
    group.add_argument('--avg-word', default=1, type=int,
                       help='whether to average pretrained embeddings onto words')
