...
from fairseq_gap.actions_interface.straight_cast import CalFlowActionsInterface as InterfaceMachine
...
def get_actions_states(*, tokens=None, actions=None, append_close=True):
    ...
    actions_states = InterfaceMachine.get_actions_and_states(actions)
...
if __name__ == '__main__':
    for split in ['train', 'valid', 'test']:
        ...
        out_file_path = f'/scratch/work/incremental-interpretation/DATA/processed/smcalflow2.0/act-top_src-ct0-npna/oracle/{split}.stats'
