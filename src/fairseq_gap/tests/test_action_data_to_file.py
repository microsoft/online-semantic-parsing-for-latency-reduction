...
from fairseq_gap.actions_preprocess.action_data_binarize import (binarize_actstates_tofile,
...
if __name__ == '__main__':
    ...
    actions_dict = Dictionary.load(
        '/scratch/work/incremental-interpretation/DATA/processed/smcalflow2.0/act-top_src-ct0-npna/fairseq_bin/dict.actions_nopos.txt'
    )
