...
[[ -z $1 ]] && echo "No data split provided; default to valid set" && subset="dev_dst" || subset=$1
...
dataflow_dialogues_dir=../DATA/treedst
graph_actions_dir=tests/data/treedst_graph
