...
log_model_tag="order-top_dlm-beam1-to-prefix-p100"

# word-rate: real voice acted utterance timing
bash $dir/eval_valid-prefix-allt_dlm-beam1-to-parser_latency_wr-real-voice.sh $exp_dir $model_dir $setting_tag &> logs_lay_search/lay${setting_tag}_300voice_${log_model_tag}.search &
