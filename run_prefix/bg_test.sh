...
if [[ ! -s $results_prefix.hypos.json ]]; then

# --nbest 3 \
# --quiet
python -m fairseq_gap.generate_dumpp \
...
##### NOTE need to have the lines corresponding to remaining lines in the valid subset
