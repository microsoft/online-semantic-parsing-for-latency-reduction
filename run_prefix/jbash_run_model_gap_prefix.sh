...
echo -e "\n[Run training and evaluation with percentage prefix data ---]"
echo $MODEL_FOLDER
...
CUDA_VISIBLE_DEVICES=$gpu /bin/bash $dir/run_model_gap_prefix.sh $config_model $seed &> $MODEL_FOLDER/log.$log_suffix &
