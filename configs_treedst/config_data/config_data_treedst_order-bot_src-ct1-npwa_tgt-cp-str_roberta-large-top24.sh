...
RAW_DIR=$DATADIR/treedst
TRAIN_RAW_FILE=$RAW_DIR/train_dst.dataflow_dialogues.jsonl
VAL_RAW_FILE=$RAW_DIR/dev_dst.dataflow_dialogues.jsonl

##### path to save processed data
DATA_ROOT_DIR=$DATADIR/processed/treedst

##### dataset source (corresponding to some different processing with lispress <-> graph and de-tokenization)
DATASET=treedst
...
EMB_FOLDER=$DATA_FOLDER/embeddings/roberta_large_top24        # pre-stored pretrained en embeddings (not changing with oracle)
