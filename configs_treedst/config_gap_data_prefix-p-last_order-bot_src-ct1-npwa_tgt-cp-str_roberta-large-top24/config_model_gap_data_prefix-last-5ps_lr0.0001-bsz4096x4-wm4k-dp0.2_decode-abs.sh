...
##### load data config
config_data=configs_treedst/config_data_prefix_order-bot/config_data_treedst_prefix-last-5ps_order-bot_src-ct1-npwa_tgt-cp-str_roberta-large-top24.sh
...
config_data=configs_treedst/config_data_abs-prefix/config_data_treedst_abs-prefix_order-top_src-ct1-npwa_tgt-cp-str_roberta-large-top24.sh
. $config_data
