...
##### load data config
config_data=configs_treedst/config_data_prefix/config_data_treedst_prefix-p100_order-top_src-ct1-npwa_tgt-cp-str_roberta-large-top24.sh
...
config_data=configs_treedst/config_data_abs-prefix/config_data_treedst_abs-prefix_from-dlm-beam1_order-top_src-ct1-npwa_tgt-cp-str_roberta-large-top24.sh
. $config_data
